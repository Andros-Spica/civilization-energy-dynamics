...
oneStock_v1_pars_text <- paste(names(oneStock_v1_pars), oneStock_v1_pars, sep = " = ", collapse = "\n")
...
```{r}
maxX = oneStock_v1_results$time[length(oneStock_v1_results$time)]
maxY = max(c(oneStock_v1_results$N, oneStock_v1_results$R))

ggplot(data = oneStock_v1_results, aes(x = time)) +
  geom_line(data = oneStock_v1_results, aes(x = time, y = S)) +
  ...
  annotate("text",
           x = 0.7 * maxX, 
           y = 0.8 * maxY,
           label = oneStock_v1_pars_text, 
           size = 5, 
           hjust = 0, 
           vjust = 1) +
  ggtitle("One stock model: constant rate")
```
...
oneStock_v2_pars_text <- paste(names(oneStock_v2_pars), oneStock_v2_pars, sep = " = ", collapse = "\n")
...
```{r}
maxX = oneStock_v2_results$time[length(oneStock_v2_results$time)]
maxY = max(c(oneStock_v2_results$N, oneStock_v2_results$R))

ggplot(data = oneStock_v2_results, aes(x = time)) +
  geom_line(data = oneStock_v2_results, aes(x = time, y = S)) +
  geom_hline(yintercept = 0, linetype = "dashed") +
  theme_bw() +
  theme(
    axis.title = element_text(size = plotScale * 10),
  ...
  annotate("text",
           x = 0.7 * maxX, 
           y = 0.8 * maxY,
           label = oneStock_v2_pars_text, 
           size = 5, 
           hjust = 0, 
           vjust = 1) +
  ggtitle("One stock model: density-dependent rate")
```
...
oneStock_v3_pars_text <- paste(names(oneStock_v3_pars), oneStock_v3_pars, sep = " = ", collapse = "\n")
...
```{r}
maxX = oneStock_v3_results$time[length(oneStock_v3_results$time)]
maxY = max(c(oneStock_v3_results$N, oneStock_v3_results$R))

ggplot(data = oneStock_v3_results, aes(x = time)) +
  geom_line(data = oneStock_v3_results, aes(x = time, y = S)) +
  geom_hline(yintercept = 0, linetype = "dashed") +
  theme_bw() +
  theme(
    axis.title = element_text(size = plotScale * 10),
  ...
  annotate("text",
           x = 0.7 * maxX, 
           y = 0.8 * maxY,
           label = oneStock_v3_pars_text, 
           size = 5, 
           hjust = 0, 
           vjust = 1) +
  ggtitle("One stock model: density-dependent rate, renewable")
```
...
oneStock_v3_model <- function(pars, init, times = times) {
  ...
  deriv <- function(t, state, pars) {
    with(as.list(c(state, pars)), {
      d_S <- k0 - k1 * S
      return(list(c(S = d_S)))  # Return both S and d_S
    })
  }
  # solve
  ode(y = state, times = times, func = deriv, parms = pars)
...
oneStock_v3_results$d_S <- abs(calculate_differences(oneStock_v3_results$S))
oneStock_v3_results$d_S_std <- oneStock_v3_results$d_S / diff(range(oneStock_v3_results$d_S))
```


```{r}
maxX = oneStock_v3_results$time[length(oneStock_v3_results$time)]
maxY = max(c(oneStock_v3_results$S, oneStock_v3_results$d_S_std))

ggplot(data = oneStock_v3_results, aes(x = time)) +
  geom_line(data = oneStock_v3_results, aes(x = time, y = S)) +
  geom_line(data = oneStock_v3_results, aes(x = time, y = d_S_std), linetype = 4) +
  geom_hline(yintercept = 0, linetype = "dashed") +
  theme_bw() +
  theme(
    axis.title = element_text(size = plotScale * 10),
  ...
  annotate("text",
           ...
           hjust = 0, 
           vjust = 1) +
  ggtitle("One stock model: Fig 3 replication")
```
...
twoStock_v1_pars_text <- paste(names(twoStock_v1_pars), twoStock_v1_pars, sep = " = ", collapse = "\n")
...
maxY = max(c(twoStock_v1_results$N, twoStock_v1_results$R))

ggplot(data = twoStock_v1_results, aes(x = time)) +
  geom_line(data = twoStock_v1_results, aes(x = time, y = R), color = "darkred") +
  geom_line(data = twoStock_v1_results, aes(x = time, y = N), color = "cyan") +
  geom_hline(yintercept = 0, linetype = "dashed") +
  theme_bw() +
  theme(
    axis.title = element_text(size = plotScale * 10),
  ...
  annotate("text",
           x = 0.7 * maxX, 
           y = 0.8 * maxY,
           label = twoStock_v1_pars_text, 
           size = 5, 
           hjust = 0, 
           vjust = 1) +
  ggtitle("Two stock model")
```
...
ggplot(data = twoStock_v1_results, aes(x = time)) +
  geom_line(data = twoStock_v1_results, aes(x = time, y = R), color = "darkred") +
  geom_line(data = twoStock_v1_results, aes(x = time, y = N_std), color = "cyan") +
  geom_hline(yintercept = 0, linetype = "dashed") +
  theme_bw() +
  theme(
    axis.title = element_text(size = plotScale * 10),
